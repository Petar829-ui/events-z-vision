...
<section className='mt-16 relative isolate'>
  ...
  <div className="lg:col-span-6 lg:col-start-7">
    ...
    <p className="text-3xl text-[#c1ff72] font-inter font-normal pb-20 px-6 sm:px-8 md:px-10 leading-relaxed max-w-7xl mx-auto z-[10]">
...
<section className="mt-16 relative isolate">
  ...
  <div className="pb-20">
    ...
    <p className="text-3xl text-[#c1ff72] font-inter font-normal leading-relaxed px-6 sm:px-8 md:px-10">
